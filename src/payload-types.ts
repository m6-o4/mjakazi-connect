...
export interface Config {
	...
	collectionsSelect: {
		...
		"expressions-of-interest":
			ExpressionsOfInterestSelect<false> | ExpressionsOfInterestSelect<true>;
...
export interface WajakaziProfile {
	...
	nationality?:
		...
		| null;
	maritalStatus?:
		("single" | "married" | "divorced" | "widowed" | "prefer_not_to_say") | null;
...
export interface Payment {
	...
	mpesaStatusCheckedAt?: string | null;
	failedAt?: string | null;
	expiredAt?: string | null;
	/**
	 * The staff or admin member who confirmed this payment by hand.
	 */
	reconciledBy?: (string | null) | User;
...
export interface ContactUnlock {
	...
	mwajiri: string | User;
	mjakazi: string | WajakaziProfile;
	source: "eoi" | "concierge" | "subscription_reveal";
...
export interface PlatformSettingsSelect<T extends boolean = true> {
	...
	eoiPolicy?:
		...
		| {
				minBatch?: T;
				maxBatch?: T;
				responseThresholdPercent?: T;
				expiryDays?: T;
				resendCooldownDays?: T;
		  };
	updatedAt?: T;
	createdAt?: T;
	globalType?: T;
