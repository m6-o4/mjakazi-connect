...
import { createClerkUser, deleteClerkUser, syncClerkUser } from "@/payload/hooks/clerk-sync";
	...
	fields: [
		...
		},
		{
			...
			options: [
				...
				{ label: "Mwajiri (Employer)", value: "mwajiri" },
				{ label: "Mjakazi (Worker)", value: "mjakazi" },
			],
			required: true,
		},
		{
